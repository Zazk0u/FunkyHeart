...
\Mods\\"Downloaded Mod"\Scripts\main.lua<br/>
Don't accidentaly extract a zip folder of one of my mod and endup with \Mods\\"Downloaded Mod"\\"Downloaded Mod"\Scripts\main.lua
