...
The structure should be FUNKYHEART\Engine\Binaries\Win64\ue4ss\Mods\\"Downloaded Mod"\Scripts\main.lua<br/>
Don't accidentaly extract a zip folder of the mod and endup with \\"Downloaded Mod"\\"Downloaded Mod"\Scripts\main.lua
